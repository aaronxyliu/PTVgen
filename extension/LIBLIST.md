...
| [socket.io](https://socket.io) | 59.7 k | Y | 128 | node.js realtime framework server |
...
| [lodash.js](http://lodash.com/) | 58.4 k | Y | 112 | A utility library delivering consistency, customization, performance, & extras. |
...
| [kotlin](http://kotlinlang.org) | 46.9 k | Y | 83 | Standard Library for Kotlin Applications |
| dayjs | 45.2 k | N | 116 | 2KB immutable date library alternative to Moment.js with the same modern API  |
| [admin-lte](http://almsaeedstudio.com) | 43.4 k | N | 52 | Admin dashboard and control panel template |
| [6to5](https://6to5.org/) | 42.8 k | Y | 190 | Turn ES6 code into readable vanilla ES5 with source maps |
| [babel-core](https://babeljs.io/) | 42.8 k | Y | 184 | A compiler for writing next generation JavaScript |
| babel-standalone | 42.8 k | Y | 118 | Standalone build of Babel for use in non-Node.js environments. Similar to the (now deprecacted) babel-browser |
| [pixi.js](http://goodboydigital.com/) | 41.9 k | Y | 225 | Pixi.js is a fast lightweight 2D library that works across all devices. |
| [leaflet](http://leafletjs.com/) | 39.4 k | Y | 52 | JavaScript library for mobile-friendly interactive maps |
...
| xlsx | 34.2 k | Y | 147 | Excel (XLSB/XLSX/XLSM/XLS/XML) and ODS spreadsheet parser and writer |
...
| core-js | 23.5 k | Y | 215 | Standard library |
...
| [tippy.js](https://atomiks.github.io/tippyjs/) | 11.5 k | Y | 144 | Vanilla JS Tooltip Library |
...
| mailcheck | 7.9 k | N | 5 | A standalone module that suggests a right domain when your users misspell it in an email address. |
...
| [decimal.js](https://mikemcl.github.io/decimal.js/) | 6.0 k | Y | 52 | An arbitrary-precision Decimal type for JavaScript. |
